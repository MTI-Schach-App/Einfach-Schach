...
const cancelGame = () => {
  fetchWrapper.post('api/game/set_game',{id:loggedUser.id,fen:defaultBoard});
...
<> 
<BackButton/>
<Button variant="contained" sx={{float:'right',marginTop:2,marginRight:1, backgroundColor:'red'}} onClick={cancelGame}>
  Aufgeben
</Button>
